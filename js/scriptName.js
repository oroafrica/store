...
export class Store
{
	...
	draw()
	{
		...
		{this.msg(this.con.accentMap(this.item.bounds).x);
			...
			im.set({left:this.con.accentMap(this.item.bounds).y,top:this.gemMap().y,originX:"center",originY:"center",objectCaching:false,noScaleCache:false,selectable:false
